...
class CANProtocol(object):
    # The keys of this dict are exposed as emulated methods.
    # The values are the command number and the argument types (in struct.pack syntax).
    protocol = {
        ...
        'strobe':       (6, 'HH'),    # time off, time total
        'cycle':        (7, 'H'),     # delay
    }
